...
double GetGPSDateTimeFromUTC(int   utc_year,   //!< The year 1900-9999
...
void GetUTCFromGPSDateTime(double gpsTime,    //!< GPS Date Time
...
#if defined(WIN32)
double GetGPSDateTimeFromSystemTime(SYSTEMTIME sysTim //!< Windows System Time
);
...
//
void e57::GetSystemTimeFromGPSDateTime(double      gpsTime, //!< GPS Date Time
                                       SYSTEMTIME& sysTim   //!< Windows System Time
)
{
...
//
double e57::GetGPSDateTimeFromUTC(int   utc_year,   //!< The year 1900-9999
...
//
void e57::GetUTCFromGPSDateTime(double gpsTime,    //!< GPS Date Time
                                int&   utc_Year,   //!< The year 1900-9999
                                int&   utc_Month,  //!< The month 0-11
                                int&   utc_Day,    //!< The day 1-31
                                int&   utc_Hour,   //!< The hour 0-23
...
//	e57::ReaderImpl
//
ReaderImpl::ReaderImpl(const ustring& filePath) : imf_(filePath, "r"), root_(imf_.root()), data3D_(root_.get("/data3D")), images2D_(root_.get("/images2D")) {}
...
bool ReaderImpl ::GetE57Root(E57Root& fileHeader) //!< This is the main header information
{
  if (IsOpen())
  {
    fileHeader.Reset();
                              ...
                              )                      //!< /return Returns true if successful
{
  if (IsOpen())
  {
    ...
    if (image.isDefined("acquisitionDateTime"))
    {
      ...
      image2DHeader.acquisitionDateTime.dateTimeValue           = FloatNode(acquisitionDateTime.get("dateTimeValue")).value();
      image2DHeader.acquisitionDateTime.isAtomicClockReferenced = (int32_t)IntegerNode(acquisitionDateTime.get("isAtomicClockReferenced")).value();
    }
    ...
    if (image.isDefined("visualReferenceRepresentation"))
    {
      ...
      if (visualReferenceRepresentation.isDefined("jpegImage"))
        image2DHeader.visualReferenceRepresentation.jpegImageSize = BlobNode(visualReferenceRepresentation.get("jpegImage")).byteCount();
      if (visualReferenceRepresentation.isDefined("pngImage"))
        image2DHeader.visualReferenceRepresentation.pngImageSize = BlobNode(visualReferenceRepresentation.get("pngImage")).byteCount();
      if (visualReferenceRepresentation.isDefined("imageMask"))
        image2DHeader.visualReferenceRepresentation.imageMaskSize = BlobNode(visualReferenceRepresentation.get("imageMask")).byteCount();

      image2DHeader.visualReferenceRepresentation.imageHeight = (int32_t)IntegerNode(visualReferenceRepresentation.get("imageHeight")).value();
      image2DHeader.visualReferenceRepresentation.imageWidth  = (int32_t)IntegerNode(visualReferenceRepresentation.get("imageWidth")).value();
    }
    ...
    if (image.isDefined("pinholeRepresentation"))
    {
      ...
      if (pinholeRepresentation.isDefined("jpegImage"))
        image2DHeader.pinholeRepresentation.jpegImageSize = BlobNode(pinholeRepresentation.get("jpegImage")).byteCount();
      if (pinholeRepresentation.isDefined("pngImage"))
        image2DHeader.pinholeRepresentation.pngImageSize = BlobNode(pinholeRepresentation.get("pngImage")).byteCount();
      if (pinholeRepresentation.isDefined("imageMask"))
        image2DHeader.pinholeRepresentation.imageMaskSize = BlobNode(pinholeRepresentation.get("imageMask")).byteCount();

      image2DHeader.pinholeRepresentation.focalLength = FloatNode(pinholeRepresentation.get("focalLength")).value();
      image2DHeader.pinholeRepresentation.imageHeight = (int32_t)IntegerNode(pinholeRepresentation.get("imageHeight")).value();
      image2DHeader.pinholeRepresentation.imageWidth  = (int32_t)IntegerNode(pinholeRepresentation.get("imageWidth")).value();

      image2DHeader.pinholeRepresentation.pixelHeight     = FloatNode(pinholeRepresentation.get("pixelHeight")).value();
      image2DHeader.pinholeRepresentation.pixelWidth      = FloatNode(pinholeRepresentation.get("pixelWidth")).value();
      image2DHeader.pinholeRepresentation.principalPointX = FloatNode(pinholeRepresentation.get("principalPointX")).value();
      image2DHeader.pinholeRepresentation.principalPointY = FloatNode(pinholeRepresentation.get("principalPointY")).value();
    }
    else if (image.isDefined("sphericalRepresentation"))
    {
      ...
      if (sphericalRepresentation.isDefined("jpegImage"))
        image2DHeader.sphericalRepresentation.jpegImageSize = BlobNode(sphericalRepresentation.get("jpegImage")).byteCount();
      if (sphericalRepresentation.isDefined("pngImage"))
        image2DHeader.sphericalRepresentation.pngImageSize = BlobNode(sphericalRepresentation.get("pngImage")).byteCount();
      if (sphericalRepresentation.isDefined("imageMask"))
        image2DHeader.sphericalRepresentation.imageMaskSize = BlobNode(sphericalRepresentation.get("imageMask")).byteCount();

      image2DHeader.sphericalRepresentation.imageHeight = (int32_t)IntegerNode(sphericalRepresentation.get("imageHeight")).value();
      image2DHeader.sphericalRepresentation.imageWidth  = (int32_t)IntegerNode(sphericalRepresentation.get("imageWidth")).value();

      image2DHeader.sphericalRepresentation.pixelHeight = FloatNode(sphericalRepresentation.get("pixelHeight")).value();
      image2DHeader.sphericalRepresentation.pixelWidth  = FloatNode(sphericalRepresentation.get("pixelWidth")).value();
    }
    else if (image.isDefined("cylindricalRepresentation"))
    {
      ...
      if (cylindricalRepresentation.isDefined("jpegImage"))
        image2DHeader.cylindricalRepresentation.jpegImageSize = BlobNode(cylindricalRepresentation.get("jpegImage")).byteCount();
      if (cylindricalRepresentation.isDefined("pngImage"))
        image2DHeader.cylindricalRepresentation.pngImageSize = BlobNode(cylindricalRepresentation.get("pngImage")).byteCount();
      if (cylindricalRepresentation.isDefined("imageMask"))
        image2DHeader.cylindricalRepresentation.imageMaskSize = BlobNode(cylindricalRepresentation.get("imageMask")).byteCount();

      image2DHeader.cylindricalRepresentation.imageHeight = (int32_t)IntegerNode(cylindricalRepresentation.get("imageHeight")).value();
      image2DHeader.cylindricalRepresentation.imageWidth  = (int32_t)IntegerNode(cylindricalRepresentation.get("imageWidth")).value();

      image2DHeader.cylindricalRepresentation.pixelHeight     = FloatNode(cylindricalRepresentation.get("pixelHeight")).value();
      image2DHeader.cylindricalRepresentation.pixelWidth      = FloatNode(cylindricalRepresentation.get("pixelWidth")).value();
      image2DHeader.cylindricalRepresentation.principalPointY = FloatNode(cylindricalRepresentation.get("principalPointY")).value();
      image2DHeader.cylindricalRepresentation.radius          = FloatNode(cylindricalRepresentation.get("radius")).value();
    }
    return true;
  }
  return false;
...
int64_t ReaderImpl ::ReadImage2DNode(e57::StructureNode image,     //!< 1 of 3 projects or the visual
...
//! This function reads one of the image blobs
bool ReaderImpl ::GetImage2DNodeSizes(e57::StructureNode image,        //!< 1 of 3 projects or the visual
                                      e57::Image2DType&  imageType,    //!< identifies the image format desired.
...
bool ReaderImpl ::GetImage2DSizes(int32_t                 imageIndex,      //!< This in the index into the image2D vector
...
int64_t ReaderImpl ::ReadImage2DData(int32_t                imageIndex,      //!< picture block index
                                     e57::Image2DProjection imageProjection, //!< identifies the projection desired.
                                     e57::Image2DType       imageType,       //!< identifies the image format desired.
                                     void*                  pBuffer,         //!< pointer the buffer
                                     int64_t                start,           //!< position in the block to start reading
  ...
  if (IsOpen())
  {
    ...
    if (scan.isDefined("pointGroupingSchemes"))
    {
      ...
      if (pointGroupingSchemes.isDefined("groupingByLine"))
      {
        ...
        data3DHeader.pointGroupingSchemes.groupingByLine.idElementName = StringNode(groupingByLine.get("idElementName")).value();
        ...
        if (lineGroupRecord.isDefined("pointCount"))
          data3DHeader.pointGroupingSchemes.groupingByLine.pointCountSize = IntegerNode(lineGroupRecord.get("pointCount")).maximum();
      }
    }
    ...
    if (scan.isDefined("acquisitionStart"))
    {
      ...
      data3DHeader.acquisitionStart.isAtomicClockReferenced = (int32_t)IntegerNode(acquisitionStart.get("isAtomicClockReferenced")).value();
    }
    ...
    if (scan.isDefined("acquisitionEnd"))
    {
      ...
      data3DHeader.acquisitionEnd.isAtomicClockReferenced = (int32_t)IntegerNode(acquisitionEnd.get("isAtomicClockReferenced")).value();
    }
    ...
    if (proto.isDefined("intensity"))
    {
      if (proto.get("intensity").type() == NodeType::E57_INTEGER)
      {
        ...
        {
          data3DHeader.intensityLimits.intensityMinimum = (double)IntegerNode(proto.get("intensity")).minimum();
          data3DHeader.intensityLimits.intensityMaximum = (double)IntegerNode(proto.get("intensity")).maximum();
        }
...
bool ReaderImpl ::GetData3DSizes(int32_t  dataIndex,   //!< image block index
  ...
  if (IsOpen())
  {
    ...
    if (scan.isDefined("indexBounds"))
    {
      ...
      if (indexBounds.isDefined("columnMaximum"))
        column = IntegerNode(indexBounds.get("columnMaximum")).value() - IntegerNode(indexBounds.get("columnMinimum")).value() + 1;

      if (indexBounds.isDefined("rowMaximum"))
        row = IntegerNode(indexBounds.get("rowMaximum")).value() - IntegerNode(indexBounds.get("rowMinimum")).value() + 1;
    }
    ...
    if (scan.isDefined("pointGroupingSchemes"))
    {
      ...
      if (pointGroupingSchemes.isDefined("groupingByLine"))
      {
        ...
        if (lineGroupRecord.isDefined("idElementValue"))
          elementSize = IntegerNode(lineGroupRecord.get("idElementValue")).maximum() - IntegerNode(lineGroupRecord.get("idElementValue")).minimum() + 1;
...
bool ReaderImpl ::ReadData3DGroupsData(int32_t  dataIndex,       //!< data block index given by the NewData3D
...
CompressedVectorReader ReaderImpl ::SetUpData3DPointsData(
  ...
  int32_t* rowIndex,    //!< pointer to a buffer with the row number of point (zero based). This is useful for data that is stored in a regular grid.Shall be in
                        //!< the interval (0, 2^63).
  int32_t* columnIndex, //!< pointer to a buffer with the column number of point (zero based). This is useful for data that is stored in a regular grid. Shall
                        //!< be in the interval (0, 2^63).
  int8_t* returnIndex,  //!< pointer to a buffer with the number of this return (zero based). That is, 0 is the first return, 1 is the second, and so on. Shall
                        //!< be in the interval (0, returnCount). Only for multi-return sensors.
  int8_t* returnCount,  //!< pointer to a buffer with the total number of returns for the pulse that this corresponds to. Shall be in the interval (0, 2^63).
...
int32_t WriterImpl ::NewImage2D(Image2D& image2DHeader //!< pointer to the Image2D structure to receive the picture information
                                )                      //!< /return Returns the image2D index
{
  ...
  if (image2DHeader.acquisitionDateTime.dateTimeValue > 0.)
  {
    ...
    acquisitionDateTime.set("isAtomicClockReferenced", IntegerNode(imf_, image2DHeader.acquisitionDateTime.isAtomicClockReferenced));
  }

  // Create pose structure for image.

  if ((image2DHeader.pose.rotation.w != 1.) || (image2DHeader.pose.rotation.x != 0.) || (image2DHeader.pose.rotation.y != 0.)
      || (image2DHeader.pose.rotation.z != 0.) || (image2DHeader.pose.translation.x != 0.) || (image2DHeader.pose.translation.y != 0.)
  ...
  if (image2DHeader.visualReferenceRepresentation.jpegImageSize > 0 || image2DHeader.visualReferenceRepresentation.pngImageSize > 0)
  {
    ...
    if (image2DHeader.visualReferenceRepresentation.jpegImageSize > 0)
      visualReferenceRepresentation.set("jpegImage", BlobNode(imf_, image2DHeader.visualReferenceRepresentation.jpegImageSize));
    else if (image2DHeader.visualReferenceRepresentation.pngImageSize > 0)
      visualReferenceRepresentation.set("pngImage", BlobNode(imf_, image2DHeader.visualReferenceRepresentation.pngImageSize));
    if (image2DHeader.visualReferenceRepresentation.imageMaskSize > 0)
      visualReferenceRepresentation.set("imageMask", BlobNode(imf_, image2DHeader.visualReferenceRepresentation.imageMaskSize));

    visualReferenceRepresentation.set("imageHeight", IntegerNode(imf_, image2DHeader.visualReferenceRepresentation.imageHeight));
    visualReferenceRepresentation.set("imageWidth", IntegerNode(imf_, image2DHeader.visualReferenceRepresentation.imageWidth));
  }
  else if (image2DHeader.pinholeRepresentation.jpegImageSize > 0 || image2DHeader.pinholeRepresentation.pngImageSize > 0)
  {
    ...
    if (image2DHeader.pinholeRepresentation.jpegImageSize > 0)
      pinholeRepresentation.set("jpegImage", BlobNode(imf_, image2DHeader.pinholeRepresentation.jpegImageSize));
    ...
    if (image2DHeader.pinholeRepresentation.imageMaskSize > 0)
      pinholeRepresentation.set("imageMask", BlobNode(imf_, image2DHeader.pinholeRepresentation.imageMaskSize));

    pinholeRepresentation.set("focalLength", FloatNode(imf_, image2DHeader.pinholeRepresentation.focalLength));
    pinholeRepresentation.set("imageHeight", IntegerNode(imf_, image2DHeader.pinholeRepresentation.imageHeight));
    ...
    pinholeRepresentation.set("principalPointX", FloatNode(imf_, image2DHeader.pinholeRepresentation.principalPointX));
    pinholeRepresentation.set("principalPointY", FloatNode(imf_, image2DHeader.pinholeRepresentation.principalPointY));
  }
  else if (image2DHeader.sphericalRepresentation.jpegImageSize > 0 || image2DHeader.sphericalRepresentation.pngImageSize > 0)
  {
    ...
    if (image2DHeader.sphericalRepresentation.jpegImageSize > 0)
      sphericalRepresentation.set("jpegImage", BlobNode(imf_, image2DHeader.sphericalRepresentation.jpegImageSize));
    else if (image2DHeader.sphericalRepresentation.pngImageSize > 0)
      sphericalRepresentation.set("pngImage", BlobNode(imf_, image2DHeader.sphericalRepresentation.pngImageSize));
    if (image2DHeader.sphericalRepresentation.imageMaskSize > 0)
      sphericalRepresentation.set("imageMask", BlobNode(imf_, image2DHeader.sphericalRepresentation.imageMaskSize));

    sphericalRepresentation.set("imageHeight", IntegerNode(imf_, image2DHeader.sphericalRepresentation.imageHeight));
    sphericalRepresentation.set("imageWidth", IntegerNode(imf_, image2DHeader.sphericalRepresentation.imageWidth));
    sphericalRepresentation.set("pixelHeight", FloatNode(imf_, image2DHeader.sphericalRepresentation.pixelHeight));
    sphericalRepresentation.set("pixelWidth", FloatNode(imf_, image2DHeader.sphericalRepresentation.pixelWidth));
  }
  else if (image2DHeader.cylindricalRepresentation.jpegImageSize > 0 || image2DHeader.cylindricalRepresentation.pngImageSize > 0)
  {
    ...
    if (image2DHeader.cylindricalRepresentation.jpegImageSize > 0)
      cylindricalRepresentation.set("jpegImage", BlobNode(imf_, image2DHeader.cylindricalRepresentation.jpegImageSize));
    else if (image2DHeader.cylindricalRepresentation.pngImageSize > 0)
      cylindricalRepresentation.set("pngImage", BlobNode(imf_, image2DHeader.cylindricalRepresentation.pngImageSize));
    if (image2DHeader.cylindricalRepresentation.imageMaskSize > 0)
      cylindricalRepresentation.set("imageMask", BlobNode(imf_, image2DHeader.cylindricalRepresentation.imageMaskSize));

    cylindricalRepresentation.set("imageHeight", IntegerNode(imf_, image2DHeader.cylindricalRepresentation.imageHeight));
    cylindricalRepresentation.set("imageWidth", IntegerNode(imf_, image2DHeader.cylindricalRepresentation.imageWidth));
    cylindricalRepresentation.set("pixelHeight", FloatNode(imf_, image2DHeader.cylindricalRepresentation.pixelHeight));
    cylindricalRepresentation.set("pixelWidth", FloatNode(imf_, image2DHeader.cylindricalRepresentation.pixelWidth));
    cylindricalRepresentation.set("principalPointY", FloatNode(imf_, image2DHeader.cylindricalRepresentation.principalPointY));
    cylindricalRepresentation.set("radius", FloatNode(imf_, image2DHeader.cylindricalRepresentation.radius));
  }
  return pos;
}
//! This function reads one of the image blobs
int64_t WriterImpl ::WriteImage2DNode(e57::StructureNode image,     //!< 1 of 3 projects or the visual
                                      e57::Image2DType   imageType, //!< identifies the image format desired.
                                      void*              pBuffer,   //!< pointer the buffer
                                      int64_t            start,     //!< position in the block to start reading
                                      int64_t            count      //!< size of desired chuck or buffer size
...
int64_t WriterImpl ::WriteImage2DData(int32_t                imageIndex,      //!< picture block index
                                      e57::Image2DType       imageType,       //!< identifies the image format desired.
                                      e57::Image2DProjection imageProjection, //!< identifies the projection desired.
                                      void*                  pBuffer,         //!< pointer the buffer
...
int32_t WriterImpl ::NewData3D(Data3D& data3DHeader,                                      //!< pointer to the Data3D structure to receive the image information
                               ...
                               )                                                          //!< /return Returns the index of the new scan.
{
  ...
  if ((data3DHeader.indexBounds.rowMinimum != 0) || (data3DHeader.indexBounds.rowMaximum != 0) || (data3DHeader.indexBounds.columnMinimum != 0)
      || (data3DHeader.indexBounds.columnMaximum != 0) || (data3DHeader.indexBounds.returnMinimum != 0) || (data3DHeader.indexBounds.returnMaximum != 0))
  {
  ...
  if ((data3DHeader.intensityLimits.intensityMaximum != 0.) || (data3DHeader.intensityLimits.intensityMinimum != 0.))
  {
    ...
    if (data3DHeader.pointFields.intensityScaledInteger > 0.)
    {
      ...
      intbox.set("intensityMaximum", ScaledIntegerNode(imf_, rawIntegerMaximum, rawIntegerMinimum, rawIntegerMaximum, scale, offset));

      intbox.set("intensityMinimum", ScaledIntegerNode(imf_, rawIntegerMinimum, rawIntegerMinimum, rawIntegerMaximum, scale, offset));
    }
    ...
    {
      intbox.set("intensityMaximum", IntegerNode(imf_, (int64_t)data3DHeader.intensityLimits.intensityMaximum));
      intbox.set("intensityMinimum", IntegerNode(imf_, (int64_t)data3DHeader.intensityLimits.intensityMinimum));
    }
  ...
  if ((data3DHeader.cartesianBounds.xMinimum != -E57_DOUBLE_MAX) || (data3DHeader.cartesianBounds.xMaximum != E57_DOUBLE_MAX))
  {
  ...
  if ((data3DHeader.sphericalBounds.rangeMinimum != 0.) || (data3DHeader.sphericalBounds.rangeMaximum != E57_DOUBLE_MAX))
  {
  ...
  if ((data3DHeader.pose.rotation.w != 1.) || (data3DHeader.pose.rotation.x != 0.) || (data3DHeader.pose.rotation.y != 0.)
      || (data3DHeader.pose.rotation.z != 0.) || (data3DHeader.pose.translation.x != 0.) || (data3DHeader.pose.translation.y != 0.)
  ...
  if (data3DHeader.acquisitionStart.dateTimeValue > 0.)
  {
    ...
    acquisitionStart.set("isAtomicClockReferenced", IntegerNode(imf_, data3DHeader.acquisitionStart.isAtomicClockReferenced));
  }
  if (data3DHeader.acquisitionEnd.dateTimeValue > 0.)
  {
    ...
    acquisitionEnd.set("isAtomicClockReferenced", IntegerNode(imf_, data3DHeader.acquisitionEnd.isAtomicClockReferenced));
  }
  ...
  if (data3DHeader.pointFields.colorRedField)
    proto.set("colorRed", IntegerNode(imf_, 0, (int64_t)data3DHeader.colorLimits.colorRedMinimum, (int64_t)data3DHeader.colorLimits.colorRedMaximum));
  ...
  if (data3DHeader.pointFields.colorBlueField)
    proto.set("colorBlue", IntegerNode(imf_, 0, (int64_t)data3DHeader.colorLimits.colorBlueMinimum, (int64_t)data3DHeader.colorLimits.colorBlueMaximum));
  ...
  if (data3DHeader.pointFields.columnIndexField)
    proto.set("columnIndex", IntegerNode(imf_, 0, E57_UINT32_MIN, data3DHeader.pointFields.columnIndexMaximum));
...
//! This funtion writes out the group data
bool WriterImpl ::WriteData3DGroupsData(int32_t  dataIndex,       //!< data block index given by the NewData3D
                                        int32_t  groupCount,      //!< size of each of the buffers given
                                        int64_t* idElementValue,  //!< index for this group
                                        int64_t* startPointIndex, //!< Starting index in to the "points" data vector for the groups
