...
: impl_(new ScaledIntegerNodeImpl(destImageFile.impl(), rawValue, minimum, maximum, scale, offset)){
    CHECK_THIS_INVARIANCE()} ScaledIntegerNode::ScaledIntegerNode(ImageFile destImageFile, int rawValue, int64_t minimum, int64_t maximum, double scale,
                                                                  double offset)
: impl_(new ScaledIntegerNodeImpl(destImageFile.impl(), (int64_t)rawValue, minimum, maximum, scale, offset)){
    CHECK_THIS_INVARIANCE()} ScaledIntegerNode::ScaledIntegerNode(ImageFile destImageFile, int rawValue, int minimum, int maximum, double scale, double offset)
...
@param   [in] configuration A string that modifies the configuration of the E57 API implementation at run-time.
Currently, in the reference implementation, this parameter is ignored.
@details
...
/*================*/ /*!
@brief   Get logical length of XML section in an E57 file.
@param   [in] fname     File name of the E57 file.
@details
Checksum on the first page of the E57 file is verified, so undetected corruption is very unlikely.
The E57 file header section must be well formed.
@return  The logical length of XML section in an E57 file.
@throw   ::E57_ERROR_BAD_API_ARGUMENT
@throw   ::E57_ERROR_LSEEK_FAILED
@throw   ::E57_ERROR_READ_FAILED
@throw   ::E57_ERROR_BAD_CHECKSUM
...
@throw   ::E57_ERROR_BAD_FILE_LENGTH
@throw   ::E57_ERROR_INTERNAL           All objects in undocumented state
@see     RawXML.cpp example, E57Utilities::rawXmlRead, E57Utilities::E57Utilities
*/ /*================*/
...
/*================*/ /*!
@brief   Read portion of XML section of an E57 file.
@param   [in] fname         File name of the E57 file.
@param   [out] buf          Buffer to receive bytes read from the XML section of the E57 file.
@param   [in] logicalStart  Position to start reading in the XML section.  First byte is 0.
@param   [in] byteCount     Number of bytes to read (length of @a buf).
@details
This function enables the extraction of the XML section of a E57 file without creating an ImageFile object.
The interspersed checksums are removed after they have been verified.
This function cannot be used to read a corrupted file (with bad checksums).
The E57 file header section must be well formed.
No validation or checking of any kind is performed on the XML read.
It is an error to attempt to read outside the XML section of the file.
It is not an error to only read a portion of the XML section in a single call.
@pre     logicalStart+byteCount <= rawXmlLength()
@throw   ::E57_ERROR_BAD_API_ARGUMENT
@throw   ::E57_ERROR_LSEEK_FAILED
@throw   ::E57_ERROR_READ_FAILED
@throw   ::E57_ERROR_BAD_CHECKSUM
...
@throw   ::E57_ERROR_BAD_FILE_LENGTH
@throw   ::E57_ERROR_INTERNAL           All objects in undocumented state
@see     RawXML.cpp example, E57Utilities::rawXmlLength, E57Utilities::E57Utilities
*/ /*================*/
