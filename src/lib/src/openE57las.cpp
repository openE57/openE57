...
LASReader::LASReader(string fname) : fs_(fname.c_str(), ios::in | ios::binary) /// Open the file for binary read
{
  if (!fs_.is_open())
  ...
  if (hdr_.fileSignature[0] != 'L' || hdr_.fileSignature[1] != 'A' || hdr_.fileSignature[2] != 'S' || hdr_.fileSignature[3] != 'F')
...
{
  os << space(indent) << "fileSignature:             " << fileSignature[0] << fileSignature[1] << fileSignature[2] << fileSignature[3] << endl;
  ...
  os << space(indent) << "projectIdGuidData4:        " << hexString(projectIdGuidData4[0]) << " " << hexString(projectIdGuidData4[1]) << " "
     << hexString(projectIdGuidData4[2]) << " " << hexString(projectIdGuidData4[3]) << " " << hexString(projectIdGuidData4[4]) << " "
     << hexString(projectIdGuidData4[5]) << " " << hexString(projectIdGuidData4[6]) << " " << hexString(projectIdGuidData4[7]) << endl;
