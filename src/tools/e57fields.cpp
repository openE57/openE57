...
ustring decimalString(uint64_t x)
{
...
public:
  ...
  ustring getPath();
  void    setRecordNumber(uint64_t recordNumber)
  {
...
: protoNode(protoNode_arg), iBuffer(new vector<int64_t>(0)), dBuffer(new vector<double>(0)), sBuffer(new vector<ustring>(0)),
...
void makeCVInfo(CompressedVectorNode cv, vector<CVElementInfo>& cvElements, ImageFile imf, Statistics& stats, vector<SourceDestBuffer>& destBuffers)
{
...
void printStats(CommandLineOptions& options, Statistics& stats, ImageFile /*imf*/)
{
  ...
  cout << "count      field name                  element type     measure    minimum      mean         maximum      count      count      first occurrence"
       << endl;
  cout
    << "========== =========================== ================ ========== ============ ============ ============ ========== ========== ================================="
    << endl;
